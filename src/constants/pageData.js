...
export const EXPERIENCE = {
  ...
  items: [
    {
      url: 'websites-preview/suse.jpg',
      websiteURL: 'https://www.suse.com/',
    },
    {
      url: 'websites-preview/personio.png',
      websiteURL: 'https://www.personio.com/',
    },
    {
      url: 'websites-preview/roweb.jpg',
      websiteURL:
        'https://roweb.ro', //optional open url in new tab
    },
    {
      url: 'websites-preview/terraform.png',
      websiteURL:
        'https://terraformcorp.com',
    },
  ],
};
...
export const SKILLS_LIST = {
  ...
  items: [
    ...
    { url: 'icons/mui-logo.png', websiteURL: null },
    { url: 'icons/css-logo.png', websiteURL: null },
    { url: 'icons/ts-logo.png', websiteURL: null },
    { url: 'icons/angular-logo.png', websiteURL: null },
    ...
    { url: 'icons/vue-logo.png', websiteURL: null },
